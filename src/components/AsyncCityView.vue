    ...
    <div class="flex flex-col flex-1 items-center">
        ...
        <div class="flex flex-col items-center text-white py-12">
            ...
            <p class="text-8xl mb-8">
                {{ Math.round((weatherData.current.temp - 32) * (5/9).toFixed(2)) }}&deg;C
            </p>
            <p>
                Feels like
                {{ Math.round((weatherData.current.feels_like -32 ) * (5/9).toFixed(2)) }} &deg;C
            </p>
            <p class="capitalize">
            ...
            <div class="mx-8 text-white">
                ...
                <div class="flex gap-10 overflow-x-scroll">
                    <div v-for="hour in weatherData.hourly" :key="hour.dt" class="flex flex-col gap-4 items-center">
                        <p calss="whitespace-nowrap text-md">
                            {{ 
                                new Date(
                                    hour.currentTime
                        ...
                        alt="">
                        <p class="text-xl">
                            {{ Math.round((hour.temp -32) * (5/9).toFixed(2)) }}&deg;C
                        </p>
                    </div>
                </div>
            </div>
        ...
        <div class="max-w-screen-md w-full py-12">
            <div class="mx-8 text-white">
                <h2 class="mb-4">7- Day Weather Report</h2>
                <div 
                    ...
                    <div class="flex gap-2 flex-1 justify-end">
                        <p>{{ Math.round((day.temp.max - 32) * (5/9).toFixed(2)) }}</p> /
                        <p>{{ Math.round((day.temp.min - 32) * (5/9).toFixed(2)) }}&deg;C</p>
                    </div>
                </div>
            </div>
        </div>
...
// const openWeatherApiKey = "0e6f69231b80c6980875aa216036cf6a"
